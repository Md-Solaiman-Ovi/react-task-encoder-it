      ...
      <div className="group py-2">
        ...
        <div className="absolute top-10 left-0 z-10 hidden w-full max-w-sm translate-x-82 rounded-b-sm bg-[rgba(31,38,50,1)] px-4 py-7 text-sm shadow-lg transition-all duration-300 ease-in-out group-hover:block">
          <ul className="space-y-2 text-base leading-7 font-normal">
            ...
            <DropDownItem
              itemName={"Hand-held Scanners (Built-in LCD Screens)"}
            />
          </ul>
        </div>
      </div>
          ...
          <div className="grid grid-cols-3 gap-10 text-base leading-7 font-normal">
            <div className="flex flex-col space-y-10">
              <ul>
                ...
                <DropDownItem
                  itemName={"Adaptive Front Lighting System (AFS) Tools"}
                />
            ...
            <div className="flex flex-col space-y-10">
              <ul>
                <DropDownItem
                  itemName={"Diesel Particulate Filter (DPF) Reset Tools"}
                />
                <DropDownItem itemName={"EGR Reset"} />
                <DropDownItem
                  itemName={"Electronic Parking Brake Reset (EPB) Tools"}
                />
            ...
            <div className="flex flex-col space-y-10">
              ...
              <ul>
                <DropDownItem
                  itemName={"Throttle Position Sensor Adjustment Tools"}
                />
                <DropDownItem
                  itemName={"Tooth/Gear Learning Diagnostic Tools"}
                />
